...
<script type="text/javascript">
    ...
    $(document).on('click', '.create-tax-{{ $rand }} #button-create-tax', function (e) {
        $('.create-tax-{{ $rand }}#modal-create-tax .modal-header').before('<span id="span-loading" style="position: absolute; height: 100%; width: 100%; z-index: 99; background: #ed1b2e; opacity: 0.4;"><i class="fa fa-spinner fa-spin" style="font-size: 16em !important;margin-left: 35%;margin-top: 8%;"></i></span>');
